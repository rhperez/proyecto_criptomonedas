...
<?php
  ...
  $table_title = 'APERTURA Y CIERRE '. (isset($_GET['book']) ? ' '.$exploded_book[0].'/'.$exploded_book[1] : ' TODOS LOS MERCADOS');
...
<head>
  ...
  <title>Digitable Trading - Aperturas y Cierres</title>
...
<body id="page-top">
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                  <thead class="thead-light">
                    <tr>
                      <th class="text-primary text-xs text-center text-uppercase">Apertura</th>
                      ...
                      <th class="text-primary text-xs text-center text-uppercase">Cierre</th>
                      <th class="text-primary text-xs text-center text-uppercase">Variación</th>
                      <th class="text-primary text-xs text-center text-uppercase">Fecha</th>
                    </tr>
                  </thead>
  ...
  <script src="js/data/datatable-openclose.js"></script>
